                ...
                switch(response) {
                    case 1:
                        try {
                            ...
                            frontOfficeModule = new FrontOfficeModule(roomRateControllerRemote, roomControllerRemote, roomTypeControllerRemote, roomInventoryControllerRemote, currentEmployee);
                            menuMain();
